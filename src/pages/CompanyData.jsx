        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-700/50 relative">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* General Information */}
              <div className="bg-gradient-to-r from-orange-800/60 to-red-800/60 p-6 rounded-2xl border border-gray-700/50 backdrop-blur-sm transition-colors duration-300">
